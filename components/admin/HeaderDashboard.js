...
const HeaderDashboard = () => {
  return (
    <div className={styles.headerDashboard}>
      <div className={styles.headerDashboard__container}>
        <img src="/agrihaLogo.svg" alt="" />
        <div className={styles.profileContainer__Header}>
          <p>Admin001</p>
          <img
      ...
      <div className={styles.top__bodyDashboard}>
        <div className={styles.left__top__bodyDashboard}>
          <Link href="/admin/dashboard" passHref>
            <div className={styles.navLink__container}>
              <img src="/admin/home.svg" alt="" />
              <p>Dashboard</p>
            </div>
          </Link>
          ...
          <Link href="/admin/architects" passHref>
            <div className={styles.navLink__container}>
              <img src="/admin/architects.svg" alt="" />
              <p>Architects</p>
            </div>
          </Link>
          <Link href="/admin/projects" passHref>
            <div className={styles.navLink__container}>
              <img src="/admin/projects.svg" alt="" />
              <p>Projects</p>
            </div>
          </Link>
          <Link href="/addArchitect" passHref>
            <div className={styles.navLink__container}>
              <img src="/admin/architects.svg" alt="" />
              <p>More</p>
            </div>
        ...
        <div className={styles.right__top__bodyDashboard}>
          {/* <div className={styles.navLink__container}>
            <img src="/admin/settings.svg" alt="" />
            <p>Settings</p>
          </div> */}
        </div>
      </div>
