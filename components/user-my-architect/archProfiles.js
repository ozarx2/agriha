          ...
          <div className={styles.archProfileDesignPic}>
            <div className={styles.archProfileSection}>
              <div className={styles.arcProfileGroupSection}>
                <img src="/img/architect/group.svg" alt="profilepic.svg" className={styles.archProPic} />
                <div className={styles.archProfileGroup}>
                  <div className={styles.archGroupName}>National Design Group</div>
            ...
            <div>
              <div className={styles.archLocationMain}>
                ...
                />
                <div className={styles.archlocation}>Pallikunnu, Kannur, Kerala, 670004</div>
              </div>
              ...
              <div className={styles.categorySubhead}>
                <div>
                  An experienced interior designer can transform your place in San Diego, CA, to make it more
                  impressive. Whether you’re strugglin. An experienced interior designer can transform your place in San
                  Diego, CA, to make it more impressive. Whether you’re strugglin.
                </div>
              </div>
              <div className={styles.readMore}>
                <Link href="/user-architect-about" passHref>
                  <div className={` ${router.pathname == "/user-architect-about" ? styles.active : ""}`}>Read more</div>
                </Link>
