...
const CartPopUp = () => {
  ...
  return (
    <div className={styles.cartPopup_outer}>
      <div className={styles.cartPopup_close} onClick={() => setCartOpen(false)}></div>
      <div className={styles.cartPopup_inner}>
        <div className={styles.cartPopup_container}>
          <div className={styles.cartPopup_container_inner}>
            ...
            <div className={styles.right_cart}>
              ...
              <div className={styles.delivery_address_button}>Delivery address +</div>
